...
(function (Calendar) {
  ...
  // Elements
  var navbarRange = $('.tui-calendar-event .tui-navbar--range');
  var prevButton = $('.tui-calendar-event .prev');
  var nextButton = $('.tui-calendar-event .next');
  var todayButton = $('.tui-calendar-event .today');
  var dropdown = $('.tui-calendar-event .dropdown');
  var dropdownTrigger = $('.tui-calendar-event .dropdown-toggle');
  // var dropdownTriggerIcon = $('.tui-calendar-event .dropdown-icon');
  var dropdownContent = $('.tui-calendar-event .dropdown-menu');
  var checkboxCollapse = $('.tui-calendar-event .checkbox-collapse');
  var sidebar = $('.tui-calendar-event .tui-sidebar');
