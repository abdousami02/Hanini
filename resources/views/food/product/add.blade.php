...
<div class="content-wrapper dashboard">
    <div class="page-header">
      <h3 class="page-title">Ajouter un Plate</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="riche-text">{{ old('description') }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Prix</label>
